	...
	<body>
		...
		<div id="newQuestionModal" class="modal">
			...
			<div class="modal-content">
				<p>
					<form accept-charset="ISO-8859-1" id="newQuestionForm" action="/sse/new-question">
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				var source = new EventSource('/sse/questions');
			...
			function sendForm() {
				// Using EventSource
			 	$.post('/sse/new-question', $('#newQuestionForm').serialize());
